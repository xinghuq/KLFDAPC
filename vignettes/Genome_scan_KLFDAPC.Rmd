...
```{r data, echo=FALSE,echo = FALSE, message = FALSE}
# Open the GDS file
...
```{r figure 1, echo=FALSE, fig.align="center", fig.height=6, fig.width=8, message=FALSE}
...
We then use the first two genetic features to do genome scan with KLFDAPT.

?KLFDAPT to see the documentation. This process is handeled with a C++ function, which is faster then normal. Users can also set the parallel process by changing the paramters of num.threshold.
...
```{r figure 2,fig.height = 6, fig.width = 8, fig.align = "center", echo = FALSE, message = FALSE}
